...
// Declaración de Funcion (Function Declarations), la expresión de la función utiliza la palabra reservada function, seguida de un nombre y un parentesis, en este parentesis se colocan los argumentos, finalmente el cuerpo de la función se define por unas llaves...
...
// Expresión de función (Function Expression) - Este tipo de funciones se asigna como si fuera una variable
