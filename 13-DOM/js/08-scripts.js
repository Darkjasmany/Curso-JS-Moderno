...
console.log(navegacion.childNodes); // Los espacios en blanco son seleccionados como elementos, son los saltos de linea del codigo html

// también existe algo llamado Children
console.log(navegacion.children); // Listan elementos reales solo html
...
//  CHILDREN RECORRIENDO A LOS HIJOS
...
console.log(card.parentElement); // Se recomienda usar este metodo porque selecciona elementos reales
console.log(card.parentElement.parentElement); // Se recomienda usar este metodo porque selecciona elementos reales
