...
function cargarEventListener() {
    ...
    // Muestra los cursos del localStorage, cuando el documento este listo
    document.addEventListener("DOMContentLoaded", () => {
        articulosCarrito = JSON.parse(localStorage.getItem("carrito")) || []; // En caso que el cliente no haya seleccionado nada lo defina como un arreglo vacio
