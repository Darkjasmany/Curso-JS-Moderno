...
// Podemos tener selectores especicificos como en CSS
...
// const segundoCard = document.querySelector("section.hospedaje");
// const segundoCard = document.querySelector(".section.hospedaje .card:nth-child(1)");
const segundoCard = document.querySelector(".hospedaje .card:nth-child(1)");
